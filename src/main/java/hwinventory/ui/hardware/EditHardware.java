...
{	  
  	public EditHardware(final HardwareDevice aHardware)
    {
      ...
      static public final class EditHardwareForm extends Form
    {
        ...
        public EditHardwareForm(final String id, final HardwareDevice aHardware)
        {
            ...
            final FormComponentFeedbackBorder typeFeedback = new FormComponentFeedbackBorder("typeFeedback");
            ...
            final FormComponentFeedbackBorder diskFeedback = new FormComponentFeedbackBorder("diskFeedback");
            final FormComponentFeedbackBorder memoryFeedback = new FormComponentFeedbackBorder("memoryFeedback");
            final FormComponentFeedbackBorder iamFeedback = new FormComponentFeedbackBorder("iamFeedback");
            final FormComponentFeedbackBorder macFeedback = new FormComponentFeedbackBorder("macFeedback");
            final FormComponentFeedbackBorder serialFeedback = new FormComponentFeedbackBorder("serialFeedback");
            final FormComponentFeedbackBorder ipFeedback = new FormComponentFeedbackBorder("ipFeedback");
            add(typeFeedback);
